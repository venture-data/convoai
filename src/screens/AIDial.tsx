...
function AIDial() {
  ...
  return (
    <div className="flex flex-col justify-between min-h-screen bg-gradient-to-b from-[#081B33] to-[#2c3e50] text-white px-8 py-8">
      ...
      <main className="flex flex-col items-center flex-grow gap-8">
        <img
          src={whisperAi}
          alt="Whisper AI"
        ...
        <div className="w-full max-w-md">
          <PhoneInput
            ...
            className="w-full bg-gray-800 text-white text-lg py-4 px-8 rounded-lg placeholder-gray-400 border-2 border-transparent focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
          />
      ...
      <footer className="text-center">
        <p className="text-gray-300 text-sm">
          Your AI-powered dialer. Powered by modern technology.
        </p>
      </footer>
